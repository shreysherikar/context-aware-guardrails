...
def test_rewrite_evaluate_full_pipeline():
    resp = client.post("/rewrite/evaluate", json={
        "agent_id": "literature-research",
...
def test_computer_session_lifecycle():
    ...
    session_resp = client.post("/computer/sessions", json={
        "agent_id": "cu-test-agent",
    ...
    action_resp = client.post(f"/computer/sessions/{session_id}/actions", json={
        "request_id": "cu-req-1",
