/**
 * Centralized API client for Expo React Native.
 *
 * Attaches Authorization: Bearer <token> when present, centralizes base URL
 * (EXPO_PUBLIC_API_BASE_URL from process.env), and normalizes error handling
 * into a consistent shape components can render.
 */
...
export async function apiFetch(
  path,
  { method = 'GET', body = null, token = null, headers = null } = {}
) {
